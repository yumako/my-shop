package com.zzz.my.shop.web.ui.controller;

import com.google.code.kaptcha.Constants;
import com.zzz.my.shop.commons.dto.BaseResult;
import com.zzz.my.shop.commons.utils.EmailSendUtils;
import com.zzz.my.shop.web.ui.api.UsersApi;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        if (user == null){
            ...
            emailSendUtils.send("用户登录", String.format("用户【%s】登录 MyShop",user.getUsername()),"yumako123@163.com");
            //将会员信息放入 session
