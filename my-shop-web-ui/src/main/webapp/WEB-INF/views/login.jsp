            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        ...
                        <input name="verification" type="text" class="itxt" placeholder="验证码" style="width: 111px;">
                        <img id="validateCode" src="/verification" style="float: right; padding-right: 32px; cursor: pointer;" title="看不清？换一张" />
                    </div>
                    <div class="remember">
                        <div class="fl">
                            <input type="checkbox">
