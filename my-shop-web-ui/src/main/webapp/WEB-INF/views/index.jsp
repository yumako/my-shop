    ...
    <div class="header-box">
        ...
        <ul class="header-right">
            <c:if test="${tbUser != null}">
                <li class="denglu">Hi~${tbUser.username}  欢迎回来!  </a> <a href="/logout">[注销]</a></li>
            </c:if>
            <c:if test="${tbUser == null}">
...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${ppt}" var="ppt">
            <li><a href="${ppt.url}" target="_blank"><img src="${ppt.pic}" alt="${ppt.title}" title="${ppt.title}"></a></li>
        </c:forEach>
    </ul>
    <ul id="two">
